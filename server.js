...
const NOTION_SCHEDULE_DB_ID = '63409866-8782-46ae-87aa-13850301249a'; // График смен — замена Supershift
...
// Список сотрудников без PIN — нужен на экране графика, чтобы подписывать смены и
// строить выпадающий список для администратора при назначении
...
// Смены за период (обычно неделя/месяц для календаря)
